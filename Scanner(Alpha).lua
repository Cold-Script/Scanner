...
-- Use _G.OnShop = true if you are using Delta
...
local function u10()
	...
	l__ScreenUI__1.Static1.ImageTransparency = 0.75;
	l__ScreenUI__1.Static2.ImageTransparency = 9e9;
	...
	l__TweenService__1:Create(l__ScreenUI__1.ViewSpecial, TweenInfo.new(1, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut, 10, true), {
